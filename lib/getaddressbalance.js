		    ...
		    client.connect(connection, "getaddressbalances", 
		    	...
		    	if (err) {
		    	    ...
		    	    for (i = 0; resp.length > i; i += 1) {
		    	        if (resp[i].name === "dicoins_v2") {
		    	        	console.log("getaddressbalance dicoins_v2 balance:"+resp[i].qty);
		    	        	assetBalance = resp[i].qty;
		    	        	break;
		    	        }
		    	    }
		    	    console.log("Getting getaddressbalance...assetBalance:"+assetBalance);
