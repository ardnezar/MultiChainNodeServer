			        ...
			        client.getaddressbalance(currentAddress, function (err, balance) {
			        	...
			        	if(err) {
	            			...
	            			if(balance >= post.price) {
	            				...
	            				transferClient.transferInternal(currentAddress, sellerAddress, post.price, function (err, response) {
	            					if(err) {
	            						...
	            						User.findOne({ 'local.username' :  username }, 
	            						          function(err, user) {
	            							if(!provideService) {
	            								user.local.balance = balance - price;
	            							} else {
	            								user.local.balance = balance + price;
	            							}
